...
function getCookie(arg1) {
    function getKey(arg1) {
        ...
        function a0j(a,b){
            var c=a0i();
            return a0j=function(d,e){d=d-0xfb;var f=c[d];
                if(a0j['tGHEKR']===undefined){
                    var g=function(l){var m='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=';
                        var n='',o='',p=n+g;
...
var arg1 = '26BF6ED1CB777A5A28099A776B806DAF41A2C24E'
console.log(getCookie(arg1));
console.log(getCookiex(arg1));
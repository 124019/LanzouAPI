...
response = requests.get(headers=headers,url="https://wwbvc.lanzouv.com/iyGhg3y8djbe?webpage=ATBbOwxpVDQGaFQ7UD0GN1MwBjZRcgAxCj0HMABsVm5VZQJlAGlVNQMpVjE_c")
html = response.text
...
ctx = execjs.compile("""
     var arg1 = '0A3272047E28E956775EE0A3DE80638774A8C88B';
        (function(a, c) {
            var G = a0j
              , d = a();
            while (!![]) {
        ...
        !(function() {
            ...
            for (var m = [0xf, 0x23, 0x1d, 0x18, 0x21, 0x10, 0x1, 0x26, 0xa, 0x9, 0x13, 0x1f, 0x28, 0x1b, 0x16, 0x17, 0x19, 0xd, 0x6, 0xb, 0x27, 0x12, 0x14, 0x8, 0xe, 0x15, 0x20, 0x1a, 0x2, 0x1e, 0x7, 0x4, 0x11, 0x5, 0x3, 0x1c, 0x22, 0x25, 0xc, 0x24], p = L(0x115), q = [], u = '', v = '', w = L(0x116), x = 0x0; x < arg1[w]; x++)
                for (var y = arg1[x], z = 0x0; z < m[w]; z++)
                    m[z] == x + 0x1 && (q[z] = y);
            for (u = q[L(0xfc)](''),
            x = 0x0; x < u[w] && x < p[w]; x += 0x2) {
                var A = (parseInt(u[L(0x11a)](x, x + 0x2), 0x10) ^ parseInt(p[L(0x11a)](x, x + 0x2), 0x10))[L(0xff)](0x10);
                0x1 == A[w] && (A = '0' + A),
                v += A;
            }
            document[L(0x121)] = 'acw_sc__v2=' + v + L(0x120) + new Date(Date[L(0x119)]() + 0x36ee80)[L(0x10c)]() + L(0x109),
            document[L(0xfe)][L(0x103)]();
        }()));
        function a0i() {
        ...
        function a0j(a, b) {
            ...
            return a0j = function(d, e) {
                ...
                if (!j) {
                    var k = function(l) {
                        this['jyamLv'] = l,
                        this['WxwaRR'] = [0x1, 0x0, 0x0],
                        this['GuwnVk'] = function() {
                            return 'newState';
                        }
                        ,
                        this['CxWuMi'] = '\x5cw+\x20*\x5c(\x5c)\x20*{\x5cw+\x20*',
                        this['FxAgTK'] = '[\x27|\x22].+[\x27|\x22];?\x20*}';
                    };
                    ...
                    k['prototype']['Hbwxmd'] = function(l) {
                        for (var m = 0x0, n = this['WxwaRR']['length']; m < n; m++) {
                            this['WxwaRR']['push'](Math['round'](Math['random']())),
                            n = this['WxwaRR']['length'];
                        }
        ...
        function b(a) {
            function c(d) {
                ...
                if (typeof d === M(0x11e))
                    return function(e) {}
                    [M(0x107)](M(0x124))[M(0x10d)](M(0x108));
                else
                    ('' + d / d)[M(0x116)] !== 0x1 || d % 0x14 === 0x0 ? function() {
                        return !![];
                    }
